 ...
 *
 */
public class ContexDJ1Process extends NeiMengGuProcessHandlePrepare {
	...
	public void analyticalProcess(Page page,PageProcessor task) {
		...
		if(Method.GET.equals(page.getRequest().getMethod())){
			...
			if(bgTrs!=null&&bgTrs.size()>2){
				...
				Request request = builderRequest(page.getRequest().getUrl()+"&"+urlTail(), Method.POST, regNumber, entName, nvps);
