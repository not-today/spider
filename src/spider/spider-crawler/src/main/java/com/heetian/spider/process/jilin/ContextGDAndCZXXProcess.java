...
import com.heetian.spider.process.shandong.CZ;
import com.heetian.spider.process.shandong.RJ;
import com.heetian.spider.process.shandong.SJ;
import com.heetian.spider.utils.AnalysisForJson;
/**
 * @author tst
 *
 */
public class ContextGDAndCZXXProcess extends JiLinProcessHandlePrepare {
	public ContextGDAndCZXXProcess(){
		this.isDownloadCodeProcess = false;
		this.isStorageProcess = true;
		setUniqueWebUri("/aiccips/pub/gsnzczxxdetail/");
	}
	@Override
