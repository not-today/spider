...
/**
 * @author tst
 * /platform/saic/baseInfo.json?entId=349DDA405B770231E04400306EF52828&departmentId=scjgw&infoClassId=dj
 */ 
public class ContexDJXXProcess extends TianJingProcessHandlePrepare {
	public ContexDJXXProcess(){
		this.isDownloadCodeProcess = false;
		this.isStorageProcess = true;
		setUniqueWebUri("/platform/saic/baseInfo.json");
