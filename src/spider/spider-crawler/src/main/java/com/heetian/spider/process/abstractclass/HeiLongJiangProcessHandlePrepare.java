...
public abstract class HeiLongJiangProcessHandlePrepare extends ProcessHandlePrepare {
	@Override
	public void createRequestForGdxxxx(String regNumber, String entName,Site site, String uuid, Page page, String requestString) {
		//详情解析
		String onclick = new Html(requestString).xpath("//a/@onclick").regex("(window\\.open\\(\\s*')(/queryInvDetailAction.jspx\\?id=\\d*)(\\s*'\\))",2).get();
