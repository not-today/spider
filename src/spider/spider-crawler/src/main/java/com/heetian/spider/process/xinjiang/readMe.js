...
function doChange(id){
	  if(id=="0"){
	    var src="ztxy.do?method=qyInfo&maent.pripid=6521223000723581&czmk=czmk1&from=&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="2"){
	    var src="ztxy.do?method=baInfo&maent.pripid=6521223000723581&czmk=czmk2&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="3"){
	    var src="ztxy.do?method=cfInfo&maent.pripid=6521223000723581&czmk=czmk3&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="4"){
	    var src="ztxy.do?method=gqczxxInfo&maent.pripid=6521223000723581&czmk=czmk4&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="5"){
	    var src="ztxy.do?method=dcdyInfo&maent.pripid=6521223000723581&czmk=czmk4&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="6"){
	    var src="ztxy.do?method=jyycInfo&maent.pripid=6521223000723581&czmk=czmk6&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="7"){
	    var src="ztxy.do?method=ccjcInfo&maent.pripid=6521223000723581&czmk=czmk7&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="8"){
	    var src="ztxy.do?method=yzwfInfo&maent.pripid=6521223000723581&czmk=czmk14&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="9"){
	    var src="ztxy.do?method=spyzInfo&maent.pripid=6521223000723581&czmk=czmk19&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="30"){
	    var src="ztxy.do?method=JcxxfjInfo&maent.pripid=6521223000723581&czmk=czmk30&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="31"){
	    var src="ztxy.do?method=YjxxInfo&maent.pripid=6521223000723581&czmk=czmk31&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="32"){
	    var src="ztxy.do?method=JsxxInfo&maent.pripid=6521223000723581&czmk=czmk32&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="33"){
	    var src="ztxy.do?method=TsxxInfo&maent.pripid=6521223000723581&czmk=czmk33&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="10"){
			var src="ztxy.do?method=xfztsjbInfo&maent.pripid=6521223000723581&czmk=czmk20&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }else if(id=="11"){
			var src="ztxy.do?method=jyjcInfo&maent.pripid=6521223000723581&czmk=czmk22&random="+new Date().getTime();
	       _openPageForSelf(src); 
	  }
	}
